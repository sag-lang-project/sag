...
impl RcEnv {
    ...
    pub fn get(&self, name: &String, value_type: Option<&ValueType>) -> Option<RcEnvVariableValueInfo> {
        let inner = self.inner.borrow();
    ...
    pub fn set(&mut self, name: String, value: RcValue, variable_type: EnvVariableType, value_type: ValueType, is_new: bool) -> Result<(), String> {
